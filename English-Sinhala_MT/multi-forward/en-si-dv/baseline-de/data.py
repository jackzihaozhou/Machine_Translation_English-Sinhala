...
class Vocab(object):
    ...
    def __init__(self):
        ...
        self.add_symbol("<sos_dv>")  # Start of sentence token for tgt=dv
...
class MTDataset_multi(data.Dataset):
    ...
    def __init__(self, vocab, prefix_1, prefix_2, src_lang="en", tgt_lang_1="si", tgt_lang_2="dv"):
        # Attributes
        self.vocab = vocab
        self.src_lang = src_lang
        ...
        for idx, tgt_sent in enumerate(self.tgt_txt_2):
            self.tgt_txt_2[idx] = f"<sos_dv> {tgt_sent} <eos>"
