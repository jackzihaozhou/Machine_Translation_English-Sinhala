...
class Vocab(object):
    ...
    def __init__(self):
        ...
        self.add_symbol("<sos>")
        self.add_symbol("<sos_si>")  # Start of sentence token for tgt=si
        self.add_symbol("<sos_hi>")  # Start of sentence token for tgt=hi
...
class MTDataset_valid(data.Dataset):
    ...
    def __init__(self, vocab, prefix, src_lang="en", tgt_lang="si"):
        ...
        for idx, src_sent in enumerate(self.src_txt):
            self.src_txt[idx] = f"<sos_si> {src_sent}"
        # Convert to indices
        self.src_idxs = [
...
#        self.src_txt = self.src_txt_1 + self.src_txt_2
        ...
        for idx, src_sent in enumerate(self.src_txt_1):
            self.src_txt_1[idx] = f"<sos_si> {src_sent}"
        for idx, src_sent in enumerate(self.src_txt_2):
            self.src_txt_2[idx] = f"<sos_hi> {src_sent}"
        self.src_txt = self.src_txt_1 + self.src_txt_2
